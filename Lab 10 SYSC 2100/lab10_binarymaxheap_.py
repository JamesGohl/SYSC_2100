...
class BinaryMaxHeap:
    ...
    def _bubble_up(self, i: int) -> None:
        ...
        while i > 0 and self._elems[i] > self._elems[parent(i)]:
            self._elems[i], self._elems[parent(i)] = self._elems[parent(
                i)], self._elems[i]  # swap child and parent
            i = parent(i)
    ...
    def _trickle_down(self, i: int) -> None:
        ...
        # Repeatedly swap the element at index i with its largest child,
        ...
        while i >= 0:
            ...
            if r < n and self._elems[r] > self._elems[i]:
                ...
                if self._elems[l] > self._elems[r]:
                    # The left child is the largest child.
                    j = l
                else:
                    # The right child is the largest child.
                    j = r
            else:
                l = left(i)
                ...
                if l < n and self._elems[l] > self._elems[i]:
                    ...
                    # element is larger than the right child, but smaller than
                    # the left child.
