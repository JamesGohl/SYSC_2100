...
#         return 1 + max(self._height(node.left), self._height(node.right))
    ...
    def postorder_print(self) -> None:
        ...
        def _postorder_print(node: 'BinaryTree._Node') -> None:
            """Print this binary tree using an postorder traversal."""
            if node is None:
                return
   ...
   # Exercise 7
    ...
    def count(self, item: any) -> int:
        ...
        def _count(node: 'BinaryTree._Node', item: any) -> None:
            """Return the number of occurrences of item in this binary tree."""
            if node is None:
                return 0
            return _count(node.left, item) + _count(node.right, item) + (node.x == item)
...
def build_binary_tree() -> BinaryTree:
    ...
    rootnode.left = BinaryTree._Node(7)     # Insert left child of root.
    # Insert left child of root left child.
    rootnode.left.left = BinaryTree._Node(17)
    # Insert right child of root left child.
    rootnode.left.right = BinaryTree._Node(9)
    rootnode.right = BinaryTree._Node(12)    # Insert right child of root.
    # Insert right child of root right child.
    rootnode.right.right = BinaryTree._Node(6)
    # Insert left child of root right child right child.
...
def build_perfect_binary_tree() -> BinaryTree:
    ...
    # Insert right child of root right child.
    rootnode.right.right = BinaryTree._Node(6)
    # Insert left child of root right child
